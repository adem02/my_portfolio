...
export const SkillsIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...props}>
        <path d="m422.917 307.702-33.552-23.664a136.252 136.252 0 0 0 0-56.076l33.552-23.663a20.445 20.445 0 0 0 5.922-26.932l-18.321-31.734a20.446 20.446 0 0 0-26.285-8.336l-37.418 17.294a135.932 135.932 0 0 0-48.41-28.056l-3.721-40.94A20.446 20.446 0 0 0 274.322 67h-36.644a20.446 20.446 0 0 0-20.362 18.595l-3.721 40.94a135.927 135.927 0 0 0-48.41 28.057l-37.419-17.295a20.446 20.446 0 0 0-26.284 8.336L83.16 177.367a20.444 20.444 0 0 0 5.922 26.932l33.553 23.664a136.253 136.253 0 0 0 0 56.075l-33.553 23.664a20.444 20.444 0 0 0-5.922 26.93l18.32 31.735a20.446 20.446 0 0 0 26.286 8.336l37.419-17.294a135.927 135.927 0 0 0 48.409 28.057l3.721 40.939A20.446 20.446 0 0 0 237.678 445h36.644a20.446 20.446 0 0 0 20.362-18.595l3.722-40.94a135.932 135.932 0 0 0 48.409-28.056l37.418 17.294a20.445 20.445 0 0 0 26.285-8.336l18.321-31.734a20.445 20.445 0 0 0-5.922-26.931ZM256 326a70 70 0 1 1 70-70 70 70 0 0 1-70 70Z" />
    </svg>
)
...
export const WorksIcon = (props) => (
    ...
    >
        ...
        <path d="M55.27 36.63a1.5 1.5 0 0 0-2 .65L45.19 53a1.5 1.5 0 1 0 2.67 1.37l8.06-15.75a1.5 1.5 0 0 0-.65-1.99ZM64.86 36.08a1.5 1.5 0 0 0-2.12 2.12l7.48 7.47-7.48 7.47a1.5 1.5 0 1 0 2.12 2.12l8.54-8.53a1.5 1.5 0 0 0 0-2.12ZM38.4 36.08a1.5 1.5 0 0 0-2.12 0l-8.54 8.54a1.5 1.5 0 0 0 0 2.12l8.54 8.54a1.5 1.5 0 0 0 2.12-2.12l-7.48-7.47 7.48-7.49a1.5 1.5 0 0 0 0-2.12Z" />
    </svg>
)
...
export const Tools = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" stroke="currentColor" {...props}>
...
export const Cloud = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" stroke="currentColor" {...props}>
        <path d="M96.2 200.1c-.13-2.7-.2-5.4-.2-8.1 0-88.4 71.6-160 160-160 59.3 0 111 32.25 138.7 80.2C409.9 101.1 428.3 96 448 96c53 0 96 42.1 96 96 0 12.2-2.3 23.8-6.4 34.6C596 238.4 640 290.1 640 352c0 70.7-57.3 128-128 128H144C64.47 480 0 415.5 0 336c0-62.8 40.17-116.2 96.2-135.9z" />
    </svg>
)

export const Mobile = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" stroke="currentColor" {...props}>
        <path d="M320 0H64C37.5 0 16 21.5 16 48v416c0 26.5 21.5 48 48 48h256c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zm-80 447.1c0 9.7-7.2 16.9-16 16.9h-64.9c-7.9 0-15.1-7.2-15.1-16s7.2-16 16-16h64c8.8 0 16 7.2 16 15.1zm64-63.1H80V64h224v320z" />
    </svg>
)

export const Frontend = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" stroke="currentColor" {...props}>
        <path d="M528 0H48C21.5 0 0 21.5 0 48v320c0 26.5 21.5 48 48 48h192l-16 48h-72c-13.2 0-24 10.8-24 24s10.8 24 24 24h272c13.25 0 24-10.75 24-24s-10.75-24-24-24h-72l-16-48h192c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zm-16 352H64V64h448v288z" />
    </svg>
)
...
export const Menu = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" viewBox="0 0 448 512" {...props}>
